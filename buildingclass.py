...
counselors = ["faith", "jeffrey", "michael owens", "mary", "alex", "molly", "emre", "lorelai", "anthony", "michael nelson",
                   "elley", "eathan"]
costs = [5, 75, 350, 1250, 3500, 15000, 80000, 390000, 1500000, 30000000, 1000000000, 1000000000000]
building_aps = [1, 10, 35, 160, 400, 1000, 5000, 22500, 125000, 1000000, 50000000, 1000000000000000000]
